...
// ✅ This uses YOUR Express server as a proxy to SofaScore
// ✅ React → Your Server → SofaScore (correct approach!)
...
function LiveMatchTracker({ bets }) {
  ...
  useEffect(() => {
    async function fetchLiveMatches() {
      try {
        // ✅ Calling YOUR server's proxy endpoint (not SofaScore directly)
